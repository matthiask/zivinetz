...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Drudge.profile_image'
        db.add_column('zivinetz_drudge', 'profile_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Drudge.profile_image'
        db.delete_column('zivinetz_drudge', 'profile_image')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 8, 31, 38, 666727)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 8, 31, 38, 666573)'}),

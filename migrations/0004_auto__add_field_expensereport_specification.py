...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExpenseReport.specification'
        db.add_column(u'zivinetz_expensereport', 'specification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['zivinetz.Specification'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'ExpenseReport.specification'
        db.delete_column(u'zivinetz_expensereport', 'specification_id')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 1, 9, 52, 3, 461903)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 1, 9, 52, 3, 461765)'}),
        ...
        u'zivinetz.expensereport': {
            ...
            'specification': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['zivinetz.Specification']", 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
        ...
        u'zivinetz.expensereportperiod': {
            'Meta': {'ordering': "['date_from']", 'object_name': 'ExpenseReportPeriod'},
            'date_from': ('django.db.models.fields.DateField', [], {}),
            'expense_report': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'periods'", 'to': u"orm['zivinetz.ExpenseReport']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'specification': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['zivinetz.Specification']"})
        },

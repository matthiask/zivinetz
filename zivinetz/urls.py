...
urlpatterns = [
    ...
    path("assignments/phone-list/", admin_required(reporting.assignment_phone_list), 
         name="zivinetz_assignment_phone_list"),
    path("expense_reports/<int:pk>/pdf/", admin_dev_admin_required(reporting.expense_report_pdf), 
         name="zivinetz_expensereport_pdf"),
    path("references/<int:pk>/pdf/", admin_required(reporting.reference_pdf), 
    ...
    path("reporting/assignmentchanges/", admin_dev_admin_required(reporting.assignmentchange_list)),
    path("expense_statistics_pdf/", admin_dev_admin_required(expenses.expense_statistics_pdf)),
    
    # Export URLs
    path("admin/drudges/pdf/", dev_admin_required(DrudgePDFExportView.as_view()), name='drudge_export'),
    path("admin/drudges/csv/", dev_admin_required(DrudgeCSVExportView.as_view()), name='drudge_export_csv'),
    path("admin/assignments/pdf/", admin_required(AssignmentPDFExportView.as_view()), name='assignment_export'),
    path("admin/assignments/csv/", admin_required(AssignmentCSVExportView.as_view()), name='assignment_export_csv'),
]

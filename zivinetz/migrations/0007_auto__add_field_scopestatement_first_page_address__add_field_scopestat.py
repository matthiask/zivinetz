...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScopeStatement.company_name'
        db.add_column(u'zivinetz_scopestatement', 'company_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ScopeStatement.company_address'
        db.add_column(u'zivinetz_scopestatement', 'company_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ScopeStatement.company_zip_code'
        db.add_column(u'zivinetz_scopestatement', 'company_zip_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'ScopeStatement.company_city'
        db.add_column(u'zivinetz_scopestatement', 'company_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ScopeStatement.company_contact_name'
        db.add_column(u'zivinetz_scopestatement', 'company_contact_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ScopeStatement.company_contact_email'
        db.add_column(u'zivinetz_scopestatement', 'company_contact_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'ScopeStatement.company_contact_function'
        db.add_column(u'zivinetz_scopestatement', 'company_contact_function',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ScopeStatement.company_contact_phone'
        db.add_column(u'zivinetz_scopestatement', 'company_contact_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ScopeStatement.work_location'
        db.add_column(u'zivinetz_scopestatement', 'work_location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScopeStatement.company_name'
        db.delete_column(u'zivinetz_scopestatement', 'company_name')

        # Deleting field 'ScopeStatement.company_address'
        db.delete_column(u'zivinetz_scopestatement', 'company_address')

        # Deleting field 'ScopeStatement.company_zip_code'
        db.delete_column(u'zivinetz_scopestatement', 'company_zip_code')

        # Deleting field 'ScopeStatement.company_city'
        db.delete_column(u'zivinetz_scopestatement', 'company_city')

        # Deleting field 'ScopeStatement.company_contact_name'
        db.delete_column(u'zivinetz_scopestatement', 'company_contact_name')

        # Deleting field 'ScopeStatement.company_contact_email'
        db.delete_column(u'zivinetz_scopestatement', 'company_contact_email')

        # Deleting field 'ScopeStatement.company_contact_function'
        db.delete_column(u'zivinetz_scopestatement', 'company_contact_function')

        # Deleting field 'ScopeStatement.company_contact_phone'
        db.delete_column(u'zivinetz_scopestatement', 'company_contact_phone')

        # Deleting field 'ScopeStatement.work_location'
        db.delete_column(u'zivinetz_scopestatement', 'work_location')
    ...
    models = {
        ...
        u'zivinetz.scopestatement': {
            ...
            'company_contact_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            'company_contact_function': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'company_contact_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'company_contact_phone': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'company_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'company_zip_code': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'eis_no': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'work_location': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },

...
class Migration(DataMigration):
    def forwards(self, orm):
        for period in orm['zivinetz.ExpenseReportPeriod'].objects.all():
            period.expense_report.specification_id = period.specification_id
            period.expense_report.save()
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 1, 9, 52, 20, 393138)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 1, 9, 52, 20, 392991)'}),
